...
EXTENDED_VALID_ELEMNTS;
    ...
    protected function registerFileManager()
    {
        ...
        $fileManagerPlugins = [
            // File upload icon/button in the insert image dialog
            'filemanager' => \Yii::getAlias('@web') . '/plugins/responsivefilemanager/filemanager/plugin.min.js',
            // File upload icon/button in toolbar.
    ...
    protected function registerTemplates()
    {
        $this->_options['templates'] = [
            [
                ...
                'content' => '<h1>Sample One</h1>'
            ],
            [
                'title' => 'Sample Two',
                'description' => 'sample-two',
                'content' => '<div style="border:1px dotted red;"><h1>Sample Two</h1></div>'
            ]
        ];
    }
